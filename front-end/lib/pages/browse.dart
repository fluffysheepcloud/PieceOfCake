        ...
        children: <Widget>[
          ...
          Container(
            padding: const EdgeInsets.only(
                bottom: 5.0, left: 50.0, right: 50.0, top: 50.0),
          ...
          results.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InfoCard(results[index]["shopName"],
                        results[index]["description"], results[index]["id"]);
                  })
              : ListView.builder(
                  scrollDirection: Axis.vertical,
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    // [cake name] , [description], [cake id], [price]
                    return InfoCard(_items[index]["shopName"],
                        _items[index]["description"], _items[index]["id"]);
                  },
                )
          //end searchbar
        ],
